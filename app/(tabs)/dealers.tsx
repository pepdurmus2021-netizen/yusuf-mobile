...
const styles = StyleSheet.create({
  ...
  dealerRight: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  actionBtn: { width: 30, height: 30, borderRadius: 10, backgroundColor: '#f8fafc', justifyContent: 'center', alignItems: 'center' },
  listHeadRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 },
  inlineAddBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: '#fff7ed', paddingHorizontal: 12, paddingVertical: 7, borderRadius: 10, borderWidth: 1, borderColor: '#fed7aa' },
  inlineAddText: { fontSize: 12, fontWeight: '800', color: '#f97316' },
  searchBox: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 14, paddingHorizontal: 14, paddingVertical: 11, gap: 8, marginBottom: 14, borderWidth: 1, borderColor: '#f1f5f9' },
  ...
  actionSheet: { backgroundColor: '#fff', borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: 20, paddingBottom: 36 },
  actionHead: { flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 18, paddingBottom: 16, borderBottomWidth: 1, borderBottomColor: '#f1f5f9' },
  actionAvatar: { width: 40, height: 40, borderRadius: 13, justifyContent: 'center', alignItems: 'center' },
  actionName: { fontSize: 15, fontWeight: '800', color: '#1e293b', flex: 1 },
  actionRow: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 12 },
  actionIconWrap: { width: 36, height: 36, borderRadius: 12, justifyContent: 'center', alignItems: 'center' },
  actionRowText: { flex: 1, fontSize: 14, fontWeight: '700', color: '#1e293b' },
  actionCancel: { marginTop: 10, backgroundColor: '#f3f4f6', borderRadius: 14, alignItems: 'center', paddingVertical: 14 },
