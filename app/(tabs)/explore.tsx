...
const s = StyleSheet.create({
  ...
  countryFlagBtn: { flex: 1, alignItems: 'center', gap: 4, backgroundColor: '#fff', borderRadius: 16, paddingVertical: 12, borderWidth: 1.5, borderColor: '#e2e8f0' },
  countryFlagBtnActive: { borderColor: '#6366f1', backgroundColor: '#eef2ff' },
  countryFlagEmoji: { fontSize: 26 },
  countryFlagName: { fontSize: 11, fontWeight: '700', color: '#94a3b8' },
  countryFlagNameActive: { color: '#4f46e5' },
